...
export const defineEpProp = <P extends EpProp<unknown, V, D | DefaultFactory<unknown, V>>, const V extends Value<unknown>, const D extends Default<unknown, V>>(
 ...
 */
export const buildProp = <T, V extends Value<T>, D extends (Default<T,V> | DefaultFactory<T, V>)>(prop: EpProp<T, V, D>, key: string) => {
...
export const buildProps = <PP extends Record<string, EpProp<unknown, V,  D | DA | DefaultFactory<unknown, V>>>, const V extends Value<unknown>, const D extends Default<unknown, V>, const DA extends Default<unknown[], V> >(props: PP & constraintsPP<PP>) => { 
  return fromPairs(
